...
public class BST<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    private boolean equals(TreeNode<E> nodeA, TreeNode<E> nodeB) {
        if (nodeA == null && nodeB == null)
            return true;
        if (nodeA != null && nodeB != null) {
            return nodeA.element.equals(nodeB.element) &&
                equals(nodeA.left, nodeB.left) &&
                equals(nodeA.right, nodeB.right);
        }
        return false;
    }
